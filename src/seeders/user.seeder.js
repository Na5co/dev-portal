...
const users = [
  ...
  },
  {
    ...
    role: 'user',
    isEmailVerified: true,
    address: { street: '202 University Dr', city: 'Collegedale', state: 'TN', zipCode: '37315' },
  ...
  },
  {
    ...
    role: 'user',
    isEmailVerified: true,
    address: { street: '303 Gigwork Rd', city: 'Contractville', state: 'TX', zipCode: '78701' },
  ...
  },
  {
    ...
    role: 'user',
    isEmailVerified: true,
    address: { street: '404 Loanly Ln', city: 'Needsmoney', state: 'GA', zipCode: '30301' },
    employmentStatus: 'employed',
    monthlyIncome: 3500,
    monthlyDebt: 2000,
    creditScore: 650,
